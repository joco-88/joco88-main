...
<head>
  ...
  <title>Webpoint Technologies - Full Service Sports Membership Platform</title>
    ...
    <!--  <h1 class="logo me-auto"><a href="index.php">Webpoint</a></h1> -->
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="#cta">Contact Us</a></li>
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h5>Proudly serving the US Olympic NGB movement for over two decades.</h5>
       ...
       <section id="about" class="about">
         <div class="container" data-aos="fade-up">
           ...
           <div class="row content">
               ...
               <p><strong>For over two decades our team has been serving the US Olympic NGB movement with highly customized integrated membership, certification and event
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-2" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-2" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-layer"></i></div>
              <h4><a href="">Event Sanctioning</a></h4>
              <p>Set up sanctions, dynamic pricing, pre-requisites, sell tickets, communications, facilities and locations; approve sanctions
                submitted by regions and clubs, set up registrations, define if the event is available online or back-end only, etc.</p>
            </div>
          </div>
            ...
            <div class="modal-content">
              <!--   Modal Header -->
                 <div class="modal-header align-items-center justify-content-center">
                   <img src="assets/img/webpoint.gif" class="modal-title  align-items-center justify-content-center" alt="" width="185"></center>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix align-items-center justify-content-center">
      <div class="copyright align-items-center justify-content-center">
        <center><br><a href="index.php" class="logo me-auto"><img src="assets/img/webpoint_logo_white.png" alt="" class="img-fluid" width=20%;></a><hr>
        &copy;  <?php echo date("Y"); ?><strong><span> - Webpoint Technologies</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
