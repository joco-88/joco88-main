...
<main>
  <div class="container-fluid">
      <br><h1>Welcome!</h1>
      <p>On this page, I will test a basic contact form with validations. Might try bootstrap styling. Also, I may add a captcha form/field to prevent more spam.</p>
  </div>
</main>
  <footer>
    <?php
