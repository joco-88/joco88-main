...
<!-- Contact form will go below this -->
  <div contactForm>
    <div class="container-fluid">
    <form action="/includes/contactform.php" method="post" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" formtarget="_self">
      <fieldset>
        ...
        <input type="email" id="email" name="email" size="30 required="true"><br>
        <label for="phone">Phone:</label><br>
        <input type="tel" id="phone" name="phone" placeholder="123-456-0000" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required="true"><br>
      ...
      <fieldset>
        <legend>Provide A Message:</legend>
         ...
         <input type="reset" value="Start Over"> -- <input type="submit" value="Submit Your Message"> <br>
      </fieldset>
    </form>
    </div>
  </div>
