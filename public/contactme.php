...
<!-- Contact form will go below this -->
  <div contactForm>
    <div class="container-fluid">
    <form action="/includes/contactform.php" method="post" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
      <fieldset>
        ...
        <input type="email" id="email" name="email" size="35 required="true"><br>
