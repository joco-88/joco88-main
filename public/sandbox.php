...
<div class="col">
    ...
    <div class="table-responsive">
      ...
      <!-- End Example Code -->
                    ...
                    <th scope="col" id="event-table-head" class="text-white" data-bs-toggle="modal" data-bs-target="#PlayerInfoModal"><img id="player-thumbnail" class="img-fluid" src="/media/keek.JPG"</img>
                      <br><a href="#PlayerInfoModal"><?php echo $player1_name;?></a></th>
