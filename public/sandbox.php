      ...
      <div class="shadow p-0 mb-5 bg-white rounded">
                  ...
                  <div id="event-header" class="card-header event"><strong><?php echo $eventTitle; ?></strong></div>
                      ...
                      <div class="table-responsive">
                                  ...
                                  <tr>
                                      <th scope="col" id="event-table-head-left" class="text-white" data-bs-toggle="modal" data-bs-target="#PlayerInfoModal" data-bs-playerId="<?php echo $player1_Id; ?>"><a href="#PlayerInfoModal">
                      <?php if ($gameWinner == 1) {
...
<!-- START OF Modal JS - Needed to dynamially alter modal content -->
<script>
const PlayerInfoModal = document.getElementById('PlayerInfoModal')
PlayerInfoModal.addEventListener('show.bs.modal', event => {
  // Button that triggered the modal
  const th = event.relatedTarget
  // Extract info from data-bs-* attributes
  const playerId = th.getAttribute('data-bs-playerId')
  ...
  modalTitle.textContent = Profile: document.write(playerId)
  modalBody.textContent = New Modal Body: Player ID: document.write(playerId)
})
</script>
