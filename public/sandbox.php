...
<div class="col">
    ...
    <div class="table-responsive">
        ...
        <svg class="bd-placeholder-img rounded float-start" width="70" height="70" xmlns="/media/keek.JPG" role="img" aria-label="Placeholder: 70x70" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title>
